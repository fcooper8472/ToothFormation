...
executable = os.path.join(chaste_build_dir, 'projects/ToothFormation/apps', 'Exe_VarAdhesion')
path_to_output = os.path.join(chaste_test_dir, 'tooth_formation', 'Exe_VarAdhesion')
...
csc = [1e6]
trl = [0.01]
tsc = np.linspace(1e6, 2e6, num=4)
ad = np.linspace(1.4, 1.6, num=4)
di = [0.02]
rf = [2500]
ts = [10000]
